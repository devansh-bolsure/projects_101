...
public class Game 
{
	...
	//and accept user input from keyboard
	
	public void update()
	{
		System.out.println("Goint to update the game");
		...
		if(!gameOver)
		{
			if(direction != DIRECTION_NONE)
			{
				...
				{
					snake.move(nextCell);
					if(nextCell.getCellType()==CellType1.FOOD)
					{
						snake.grow();
						board.generateFood();
					}
	...
	public static void main(String[] args) 
	{
		...
		//here i just called the different methods 
